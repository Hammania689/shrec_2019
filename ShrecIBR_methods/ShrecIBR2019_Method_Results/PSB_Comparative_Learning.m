...
hHCMUS_Run_2=plot(HCMUS_Run_2(:,1),HCMUS_Run_2(:,2),'k-d', 'LineWidth',2,'MarkerSize',8,'MarkerFaceColor','m');%axis square,'View Context')
hold on,
...
H=[hHCMUS_Run_1 hHCMUS_Run_2 hCVAE_Run_2 hCVAE_Run_1 hCVAE_Run_2 hCVAE_Run_3 hCVAE_Run_4 ];
% 'Tran (RNIRAP1)', 'Tran (RNIRAP2)' , 'Tran (RNIRAP3)', 'Tran (BoW1)', 'Tran (BoW2)'
legend(H, 'Triet (HCMUS1)', 'Triet (HCMUS2)', 'Rey (CVAE-VGG)', 'Rey (CVAE1)', 'Rey (CVAE2)', 'Rey (CVAE3)', 'Rey (CVAE4)');
